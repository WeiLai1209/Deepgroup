...
BATCH_SIZE = 128
# python train_hashlayer_gh.py D:\PythonProject\deepsketch-fast2022-main\training\model\model_tag_8192_2048_1e-05.torchsave D:\PythonProject\deepsketch-fast2022-main\training\data_tag_pre 128 1 0.00005 1

# python train_hashlayer_gh.py
# basemodel_filenameD:\PythonProject\deepsketch-fast2022-main\training\model\model_tag_8192_2048_1e-05.torchsave
# path=D:\PythonProject\deepsketch-fast2022-main\training\data_tag_pre
# _hashSize=128
# _which_dense=1
# _lr=0.02
# alpha=1
# python train_hashlayer_gh.py D:\PythonProject\deepsketch-fast2022-main\training\model\model_tag_4096_2048_1e-05.cp.torchsave D:\PythonProject\deepsketch-fast2022-main\training\data_tag_pre 128 1 0.02 1
basemodel_filename = sys.argv[1]
...
_hashSize = int(sys.argv[3])      # 本研究在不同的学习率λ上评估了B的三个候选值 32、64和128
_which_dense = int(sys.argv[4])   # 1 or 2
...
def compute_correct(outputs, targets): # for each batch
    prob, label = outputs.topk(5, 1, True, True)
